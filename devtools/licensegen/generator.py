...
class LicenseGenerator:
    ...
    def fetch_available_licenses(self) -> List[Dict]:
        ...
        try:
            ...
            if rate_limit_response.status_code == 200:
                ...
                if remaining == 0:
                    raise ValueError("GitHub API rate limit exceeded. Please set a GitHub token using:\ndevtools config set GITHUB_TOKEN YOUR_GITHUB_TOKEN")
                ...
                try:
                    ...
                    if license_response.status_code == 200:
                        ...
                        detailed_licenses.append({
                            ...
                            "description": license_data.get("description", "No description available"),
    ...
    def generate_license(self, license_type: str, author: str, year: Optional[int] = None) -> str:
...
def generate_license(license_type: str, author: str, year: Optional[int] = None, output_file: str = "LICENSE") -> str:
