...
class OpenAIProvider(AIProvider):
    ...
    def setup(self, config: BaseConfig) -> None:
        ...
        if not self.api_key:
            raise ValueError("OpenAI API key not found. Please set it in config or environment.")
...
class GeminiProvider(AIProvider):
    ...
    def setup(self, config: BaseConfig) -> None:
        ...
        if not self.api_key:
            raise ValueError("Google API key not found. Please set it in config or environment.")
...
class ClaudeProvider(AIProvider):
    ...
    def setup(self, config: BaseConfig) -> None:
        ...
        if not self.api_key:
            raise ValueError("Anthropic API key not found. Please set it in config or environment.")
...
class HuggingFaceProvider(AIProvider):
    ...
    def setup(self, config: BaseConfig) -> None:
        ...
        if not self.api_key:
            raise ValueError("Hugging Face API key not found. Please set it in config or environment.")
...
class AIService:
    ...
    def _get_provider(self) -> AIProvider:
        ...
        if provider not in providers:
            raise ValueError(f"Unsupported AI provider: {provider}. Supported providers: {', '.join(providers.keys())}")
